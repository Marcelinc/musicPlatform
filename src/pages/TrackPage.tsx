...
import '../resources/TrackPage.css'
...
const TrackSiteContainer = () => {
  ...
  useEffect(() => {
    ...
    if(id){
      ...
      //redirect to error page if there is no track that user is looking for
      //if(!trackObject)
       // navigate('/errorPage');
    }
  },[])
    ...
    <div className="track-container">
      <main id='track-content'>
        ...
        <TrackInfoSection title="Artist">
          {track?.artist.map(a => <ArtistBlock key={a.id} artistName={a.artistName} artistImageSrc={a.artistImageSrc} artistId={a.id}/>)}
        </TrackInfoSection>
